...
final class RepositoriesStorage {
    private let interactors: CoreRepositoryAssembler
    ...
    private init(interactors: CoreRepositoryAssembler) {
        self.interactors = interactors
    }

    static func create(taskBridge: TaskBridge) -> RepositoriesStorage {
        return taskBridge.bootstrap { interactors in
            RepositoriesStorage(interactors: interactors)
        } as! RepositoriesStorage
    }
    ...
    var navigationRepository: NavigationRepository {
        ...
        let repository = NavigationRepositoryImpl(interactor: interactors.navigationInteractor())
    ...
    var taskTemplatesRepository: TaskTemplatesRepository {
        ...
        let repository = TaskTemplatesRepositoryImpl(interactor: interactors.templatesInteractor())
    ...
    var tasksRepository: TasksRepository {
        ...
        let repository = TasksRepositoryImpl(interactor: interactors.tasksInteractor())
    ...
    var remindersRepository: RemindersRepository {
        ...
        let repository = RemindersRepositoryImpl(interactor: interactors.remindersInteractor())
    ...
    var messagesRepository: MessagesRepository {
        ...
        let repository = MessagesRepositoryImpl(interactor: interactors.messagesInteractor())
